...
function App() {
  ...
  const handleMoreDetails3 = () => {
    ...
    // setShowHotel3(false); // Hide other hotel details
  };

  const handleMoreDetails4 = () => {
    setShowHotel4(!showHotel4);
    // setShowHotel4(false); // Hide other hotel details
  };

  const handleMoreDetails5 = () => {
    setShowHotel5(!showHotel5);
    // setShowHotel5(false); // Hide other hotel details
  };

  const handleMoreDetails6 = () => {
    setShowHotel6(!showHotel6);
    // setShowHotel6(false); // Hide other hotel details
  };

  const handleMoreDetails7 = () => {
    setShowHotel7(!showHotel7);
    // setShowHotel7(false); // Hide other hotel details
  };

  const handleMoreDetails8 = () => {
    setShowHotel8(!showHotel8);
    // setShowHotel8(false) // Hide other hotel details
  };

  const handleMoreDetails9 = () => {
    setShowHotel9(!showHotel9);
    // setShowHotel9(false); // Hide other hotel details
  };

  const handleMoreDetails10 = () => {
    setShowHotel10(!showHotel10);
    // setShowHotel10(false); // Hide other hotel details
  };

  const handleMoreDetails11 = () => {
    setShowHotel11(!showHotel11);
    // setShowHotel11(false); // Hide other hotel details
  };

  const handleMoreDetails12 = () => {
    setShowHotel12(!showHotel12);
    // setShowHotel12(false); // Hide other hotel details
  };
    ...
    <>
      ...
      {!loggedIn ? (
        ...
        <div className="text-slate-800 max-w-7xl max-h-full p-4 mx-auto">
          <header className="bg-white dark:bg-gray-900 dark:text-gray-100 mb-3">
            <div className="flex flex-wrap justify-between items-center px-4 py-3">
              <div className="flex items-center gap-2 text-2xl md:text-5xl font-serif">
            ...
            <nav className="w-11/12 mx-auto mt-3 bg-white dark:bg-gray-900 dark:text-gray-100">
              <ul className="flex flex-wrap justify-between items-center text-xl md:text-3xl font-bold">
                <li className="cursor-pointer p-2 hover:text-slate-600 hover:translate-y-1 transition-transform">
        ...
        <main className="w-full h-screen mt-8 bg-[url('./assets/sea.jpg')] bg-no-repeat bg-center bg-cover dark:bg-gray-900 dark:text-gray-100">
          <div className="text-center px-6 md:px-14 dark:bg-gray-900 dark:text-gray-100">
            <h1 className="text-white text-4xl sm:text-5xl md:text-7xl font-bold mt-10 pt-24 md:pt-44">
              Independent travel advisors, working for you
            </h1>
            <p className="text-white text-xl sm:text-2xl md:text-4xl font-bold p-4 md:p-10">
              Worry-Free, Expert Planning Unforgettable Luxury Experiences<br />
              VIP access to the World’s Best Hotels, Tours, and Cruises
            </p>
            <button className="mt-6 p-2 bg-white text-red-500 text-lg sm:text-xl md:text-2xl font-serif font-bold rounded-md hover:bg-red-500 hover:text-white transition-colors">
          ...
          <div className='mt-5 dark:bg-gray-900 dark:text-gray-100' id='hotel'>
            <div className='mt-4 text-center'>
              <h1 className='uppercase text-2xl sm:text-3xl md:text-4xl font-bold font-serif'>
                Hotel
              </h1>
              <p className='capitalize text-base sm:text-lg lg:text-2xl lg:font-extrabold'>Find your hotel</p>
            </div>
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 dark:bg-gray-900 dark:text-gray-100 mt-6'>
              <div className='w-full max-w-sm h-auto mx-auto'>
                <div className='w-full h-1/2'>
                  <img className='w-full h-full object-cover' src={hotell} alt=""/>
                </div>
                <div className='w-full text-center mt-5'>
                  <button className='-red-500 text-lg sm:text-xl font-semibold font-serif hover:text-slate-600 hover:translate-y-1' onClick={handleMoreDetails1}>
                    Hotel South Beach
                  </button>
                  <p className='text-base sm:text-lg capitalize mt-3'>miami beach, FL United States</p>
                </div>

                {/* {The starting of this Hotel details} */}
                {showHotel1 && (
                  <div className='w-full max-w-5xl mx-auto border relative'>
                    <div className='w-full h-60 sm:h-80 md:h-96 dark:bg-gray-900 dark:text-gray-100'>
                      <img className='w-full h-full ' src={hotell} alt=""/>
                    </div>
                    <div className='bg-slate-100 text-center px-6 sm:px-12 md:px-20 dark:bg-gray-900 dark:text-gray-100'>
                      <h1 className='pt-5 text-2xl sm:text-3xl md:text-4xl font-semibold'>Hotel Brooklyn Bridge</h1>
                      <h2 className='mt-3 text-xl sm:text-2xl md:text-3xl font-semibold'>Brooklyn, NY United States</h2>
                      <p className='text-sm sm:text-base md:text-lg'>Address</p>
                      <p className='text-sm sm:text-base md:text-lg'>60 Furman St</p>
                      <p className='text-sm sm:text-base md:text-lg'>Brooklyn, New York 11201-1325</p>
                      ...
                      <h2 className='pt-5 text-lg sm:text-xl md:text-2xl font-semibold'>Virtuoso Amenities for your stay:</h2>
                      <ul className='list-disc pl-5 sm:pl-8 text-sm sm:text-base md:text-lg'>
                        <li>Upgrade on arrival, subject to availability</li>
                        <li>Daily breakfast credit of $25 per person, for up to two guests per bedroom</li>
                        <li>$100 USD Food & Beverage credit, once during stay</li>
                        <li>Early Check-In / Late Check-Out, subject to availability</li>
                        <li>Complimentary Wi-Fi</li>
                      </ul>

                      <div className='mt-8'>
                        <h1 className='text-xl sm:text-2xl font-semibold'>At the Hotel</h1>
                        <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4'>
                          <h2 className='pt-5 text-lg sm:text-xl md:text-2xl font-semibold'>Features</h2>
                          <p>24-hour Security, Air Conditioning, Banquet Facilities, Conference Facilities, Internet Access, Parking, Pet Friendly</p>

                          <h2 className='pt-5 text-lg sm:text-xl md:text-2xl font-semibold'>Services</h2>
                          <p>Concierge Desk, Laundry/Dry Cleaning/Pressing, Valet Parking, Wakeup Calls, Wedding Services</p>

                          <h2 className='pt-5 text-lg sm:text-xl md:text-2xl font-semibold'>Recreation</h2>
                          <p>Bicycle Rental, Fitness Center, Pool, Sauna</p>

                          <h2 className='pt-5 text-lg sm:text-xl md:text-2xl font-semibold'>In Your Room</h2>
              ...
              <div className='w-full max-w-sm h-auto mx-auto'>
                ...
                <div className='w-full text-center mt-5'>
                  <button className='text-red-500 text-lg sm:text-xl font-semibold font-serif hover:text-slate-600 hover:translate-y-1' onClick={handleMoreDetails2}>Pines Resort Ibiza</button>
                  <p className='text-base sm:text-lg capitalize mt-3'>Ibiza, Spain</p>
                </div>
                ...
                {showHotel2 && <div className='w-[80rem] border relative -ml-[420px]'>
                  ...
                  <div className='bg-slate-100 text-center px-6 sm:px-12 md:px-20 dark:bg-gray-900 dark:text-gray-100'>
                    <h1 className='pt-5 text-2xl sm:text-3xl md:text-4xl font-semibold'>Pines Resort Ibiza</h1>
                    <h2 className='mt-3 text-xl sm:text-2xl md:text-3xl font-semibold'>San José, Spain</h2>
                    <p className='text-sm sm:text-base md:text-lg'>Address</p>
                    <p className='text-sm sm:text-base md:text-lg'>Calle Puig Delfin</p>
                    <p className='text-sm sm:text-base md:text-lg'>s/n</p>
                    <p className='text-sm sm:text-base md:text-lg'>Ibiza</p>
                    <p className='text-sm sm:text-base md:text-lg'>San José, 07830</p>
                    <p className='text-sm sm:text-base md:text-lg'>Spain</p>

                    <p className='mt-6 text-base sm:text-lg md:text-xl'>A CULINARY DESTINATION Set within the vibrant culinary landscape of the island, 7Pines Resort Ibiza, a part of Destination by Hyatt, stands out as a culinary haven showcasing some of Ibiza's most acclaimed restaurants. Guests can enjoy a seat overlooking the dramatic cliff facing Es Vedrà and indulge in delightful creations throughout the day. Whether it's a hearty breakfast, a leisurely late lunch by our infinity or lagoon pool, tapas and drinks at sunset at Cone Club, sushi served Izakaya style at Pershing Yacht Terrace, or fine dining at The View, there's something to tantalize every palates.</p>

                    <p className='pt-5 text-lg sm:text-xl md:text-2xl font-semibold'>Virtuoso Amenities for your stay:</p>

                    <h2 className='pt-5 text-lg sm:text-xl md:text-2xl font-semibold'>For 2024:</h2>
                    <p>
                      <ul className='list-disc pl-5 sm:pl-8 text-sm sm:text-base md:text-lg'>
                        <li>Upgrade on arrival, subject to availability</li>
              ...
              <div className='w-full max-w-sm h-auto mx-auto'>
                ...
                {showHotel4 && <div className='w-[80rem] border relative '>
                  ...
                  <div className='bg-slate-100 text-center px-64'>
                    ...
                    <h2 className='pt-5 text-lg sm:text-xl md:text-2xl font-semibold'>Hersonissos, Crete, Greece</h2>
                    <p className='text-sm sm:text-base md:text-lg'>Address</p>
                    <p className='text-sm sm:text-base md:text-lg'>Themistokleous Avenue, Hersonissos</p>
                    <p className='text-sm sm:text-base md:text-lg'>Hersonissos, Crete, 70014</p>
                    <p className='text-sm sm:text-base md:text-lg'>Greece</p>

                    <p className='mt-6 text-base sm:text-lg md:text-xl'>Let loose at Abaton Island Resort & Spa, a labyrinth of gleaming white cubes located along Crete’s north coast just steps from gleaming beaches. The mod structures house 152 Zen-chic rooms, suites, and villas (many with private pools), plus an Elemis spa and five restaurants – including the island’s first Buddha-Bar Beach, which serves Asian fusion fare, DJ-spun music, and creative mixology all summer long. Parasol-covered sunbeds line 1,200 feet of shoreline, while the infinity-edge pool absolutely dazzles.</p>
              ...
              <div className='w-full max-w-sm h-auto mx-auto'>
                ...
                {showHotel5 && <div className='w-[80rem] border relative -ml-[450px]'>
                  <div className='w-full h-60 sm:h-80 md:h-96 dark:bg-gray-900 dark:text-gray-100'>
                    <img className='w-full h-full object-cover' src={hotel5} alt=""/>
                  </div>
                  <div className='bg-slate-100 text-center px-64'>
                    <h1 className='pt-5 text-4xl font-semibold'>Abercrombie & Kent Villas</h1>
                    <h2 className='pt-5 text-lg sm:text-xl md:text-2xl font-semibold'>Cheltenham, United Kingdom</h2>
                    <p className='text-sm sm:text-base md:text-lg'>Address</p>
                    <p className='text-sm sm:text-base md:text-lg'>St. George's House</p>
                    <p className='text-sm sm:text-base md:text-lg'>Ambrose Street</p>
                    <p className='text-sm sm:text-base md:text-lg'>Cheltenham, GL50 3LG</p>
                    <p className='text-sm sm:text-base md:text-lg'>United Kingdom</p>

                    <p className='mt-6 text-base sm:text-lg md:text-xl'>From chic beach retreats to countryside manors, Abercrombie & Kent has handpicked the best stays in idyllic locations. You can choose from a waterfront break away or a celebrity-worthy hideaway. Reserve a Scottish golf retreat for 10 near historic St Andrews or host next year’s family reunion at a magnificent 12-bedroom estate in the Caribbean. The best part is that every villa comes with its own concierge to orchestrate sightseeing tours to yacht rentals and booking the best table in your local Michelin-starred restaurant.</p>
              ...
              <div className='w-full max-w-sm h-auto mx-auto'>
                ...
                {showHotel6 && <div className='w-[80rem] border relative -ml-[850px]'>
                  <div className='w-full h-60 sm:h-80 md:h-96 dark:bg-gray-900 dark:text-gray-100'>
                    <img className='w-full h-full object-cover' src={hotel7} alt=""/>
                  </div>
                  <div className='bg-slate-100 text-center px-64'>
                    <h1 className='pt-5 text-4xl font-semibold'>Acqualina Resort & Residences on the Beach</h1>
                    <h2 className='pt-5 text-lg sm:text-xl md:text-2xl font-semibold'>Miami Beach, FL United States</h2>
                    <p className='text-sm sm:text-base md:text-lg'>Address</p>
                    <p className='text-sm sm:text-base md:text-lg'>17875 Collins Ave</p>
                    <p className='text-sm sm:text-base md:text-lg'>Miami Beach, Florida 33160</p>
                    <p className='text-sm sm:text-base md:text-lg'>United States</p>

                    <p className='mt-6 text-base sm:text-lg md:text-xl'>Acqualina Resort & Residences is an award-winning Forbes Five Star, AAA Five Diamond property situated on 400 feet of pristine white sands. The resort’s unobstructed views create a unique, sea-level experience as the lush green gardens effortlessly succumb to the sand. Here, guests enjoy expansive amenities, including three oceanfront swimming pools; four restaurants, including the new Avra Miami and Il Mulino New York; a tranquil spa; and a marine-biology-inspired kids’ program.</p>
              ...
              <div className='w-full max-w-sm h-auto mx-auto'>
                ...
                {showHotel7 && <div className='w-[80rem] border relative '>
                  <div className='w-full h-60 sm:h-80 md:h-96 dark:bg-gray-900 dark:text-gray-100'>
                    <img className='w-full h-full object-cover' src={hotel8} alt=""/>
                  </div>
                  <div className='bg-slate-100 text-center px-64'>
                    <h1 className='pt-5 text-4xl font-semibold'>Adare Manor</h1>
                    <h2 className='pt-5 text-lg sm:text-xl md:text-2xl font-semibold'>Limerick, Ireland</h2>
                    <p className='text-sm sm:text-base md:text-lg'>Address</p>
                    <p className='text-sm sm:text-base md:text-lg'>Adare Village</p>
                    <p className='text-sm sm:text-base md:text-lg'>Limerick, V94 W8WR</p>
                    <p className='text-sm sm:text-base md:text-lg'>Ireland</p>

                    <p className='mt-6 text-base sm:text-lg md:text-xl'>Adare Manor is a five-star luxury resort defined by its spectacular setting, authentic historic character and the impeccable service and welcome of its world-class team. The 103 guest rooms are air-conditioned and lavishly appointed with original art, Georgian-style furnishings and marble bathrooms. For fine dining, visit The Carriage House for cocktails and classic Irish cuisine or Michelin-star Oak Room restaurant with renowned chef Michael Tweedie. Get out on the greens at the pristine golf course, redesigned by Tom Fazio and the forthcoming host venue for the 2027 Ryder Cup, or experience our new resort wellness facility, the Padel Club.</p>
              ...
              <div className='w-full max-w-sm h-auto mx-auto'>
                ...
                {showHotel10 && <div className='w-[80rem] border relative'>
                  ...
                  <div className='bg-slate-100 text-center px-64'>
                    ...
                    <h2 className='pt-5 text-lg sm:text-xl md:text-2xl font-semibold'>Versailles, France</h2>
                    <p className='mt-5'>Neighborhood</p>
                    <p>Lakes of Killarney</p>

                    <p className='text-sm sm:text-base md:text-lg'>Address</p>
                    <p className='text-sm sm:text-base md:text-lg'>Le Grand Contrôle,</p>
                    <p className='text-sm sm:text-base md:text-lg'>12 rue de l’Indépendance Américaine</p>
                    <p className='text-sm sm:text-base md:text-lg'>Versailles, 78000</p>
                    <p className='text-sm sm:text-base md:text-lg'>France</p>

                    <p className='mt-6 text-base sm:text-lg md:text-xl'>With its famous address, late eighteenth-century Marie Antoinette vibes, and personal butler service, Airelles Château de Versailles gives you a taste of French royalty life. In addition to 13 period-appropriate suites (think chevron parquet flooring and clawfoot tubs), the hotel features a restaurant where you can indulge in feasts fit for a king, plus a spa – complete with pool, sauna, and hammam – adorned with statues and hand-painted frescoes.</p>
              ...
              <div className='w-full max-w-sm h-auto mx-auto'>
                ...
                {showHotel11 && <div className='w-[80rem] border relative -ml-[450px]'>
                  ...
                  <div className='bg-slate-100 text-center px-64'>
                    ...
                    <h2 className='pt-5 text-lg sm:text-xl md:text-2xl font-semibold'>Courchevel, France</h2>

                    <p className='text-sm sm:text-base md:text-lg'>Address</p>
                    <p className='text-sm sm:text-base md:text-lg'>rue du Jardin Alpin</p>
                    <p className='text-sm sm:text-base md:text-lg'>Courchevel, 73120</p>
                    <p className='text-sm sm:text-base md:text-lg'>France</p>

                    <p className='mt-6 text-base sm:text-lg md:text-xl'>In the heart of Jardin Alpin, the most elegant district of Courchevel 1850, Airelles Courchevel, Les Airelles offers a timeless experience. On the slopes, the ski experience is enhanced by the attention and care provided by Les Airelles’ dedicated team. An Austro-Hungarian castle spirit meets the chalet style, promising mountain lovers an unbeatable alpine experience. The beauty of the hotel’s pastel-hued frescoes, the diversity of stained-glass windows, and the refinement of its materials give the property an inimitable style that the elite crave. Les Airelles is the icon of French alpine luxury, where every single wish comes true.</p>
           ...
           <div className='mt-5 dark:bg-gray-900 dark:text-gray-100' id='cruise'>
            <div className='mt-4 text-4xl font-bold font-serif w-80 text-center m-auto mb-6 dark:bg-gray-900 dark:text-gray-100'>
              <h1 className='uppercase text-2xl sm:text-3xl md:text-4xl font-bold font-serif'>Cruise</h1>
              <p className='capitalize text-base sm:text-lg lg:text-2xl lg:font-extrabold'>Find your cruise</p>
            </div>
                ...
                {showTour2 && <div className='w-[80rem] border relative -ml-[476px]'>
                  ...
                  <div className='bg-slate-100 text-center px-64 '>
                    ...
                    <div className='px-40'>
                      ...
                      <h2 className='pt-5 text-lg sm:text-xl md:text-2xl font-semibold'>Service</h2>
